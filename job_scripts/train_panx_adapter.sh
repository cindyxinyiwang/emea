...
TASK='panx'
LANGS="en,fo,no,da,mr,bn,ta,bg,be,uk"
TRAIN_LANGS="en"
...
for SEED in 1;
do
OUTPUT_DIR="$OUT_DIR/$TASK/${MODEL}-LR${LR}-epoch${NUM_EPOCHS}-MaxLen${MAX_LENGTH}-TrainLang${TRAIN_LANGS}_${ADAPTER_LANG}_s${SEED}/"
