...
class CombineTextDataset(Dataset):
    ...
    def __init__(
        ...
        self.examples = self.load_file(tokenizer, file_path, block_size, overwrite_cache, cache_dir)
        self.meta_examples = self.load_file(tokenizer, meta_file_path, block_size, overwrite_cache, cache_dir)

    def load_file(self, tokenizer, file_path, block_size, overwrite_cache, cache_dir):
    ...
    def __getitem__(self, i) -> torch.Tensor:
        return torch.tensor(self.examples[i], dtype=torch.long), torch.tensor(self.meta_examples[i%len(self.meta_examples)], dtype=torch.long)
